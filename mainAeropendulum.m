...
Xi_BPDN_noise = minimize_cost(Theta,0.99,0.001,dx,'BPDN');
...
[tResult_test,xResult_test,u,dx] = simulateSystem(t_interval,xResult_noise(7000,:),Xi_ridge_noise,u_control_test,n,usesine,polyorder);
